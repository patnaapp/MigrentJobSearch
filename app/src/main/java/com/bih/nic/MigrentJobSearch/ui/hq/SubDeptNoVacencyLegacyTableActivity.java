...
public class SubDeptNoVacencyLegacyTableActivity extends Activity implements AdapterView.OnItemSelectedListener  {
...
//        });
    ...
    {
        private final ProgressDialog dialog = new ProgressDialog(SubDeptNoVacencyLegacyTableActivity.this);
        int optionType;
        String serial_no;
        ...
        protected ArrayList<SubDepartmentWiseVacancy> doInBackground(String...arg)
        {
            ...
            return WebserviceHelper.getSubDeptWiseVacencyReport("ShowWrkReq", dept_Code);
        }
