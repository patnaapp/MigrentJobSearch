...
public class SubDeptLegacyTableActivity extends Activity implements AdapterView.OnItemSelectedListener  {
...
//        });
    ...
    {
        private final ProgressDialog dialog = new ProgressDialog(SubDeptLegacyTableActivity.this);
        int optionType;
        String serial_no;
        ...
        protected void onPostExecute(ArrayList<SubDepartmentWiseVacancy> result)
        {
            ...
            LegacyTableView.insertLegacyTitle("क्रम सं.","कंपनी", "कार्य स्थल", "स्थान","संपर्क व्यक्ति","संपर्क व्यक्ति मोबाइल नं");
            //  LegacyTableView.insertLegacyTitle("क्रम सं.","पंजीकरण संख्या", "कौशल", "नाम", "लिंग","मोबाइल नंबर","कार्य स्थल का नाम");
