...
public class SubDeptWorkPlaceLegacyTableActivity extends Activity implements AdapterView.OnItemSelectedListener  {
...
//        getActionBar().hide();
        ...
        tv_skill11.setText("विभाग-कार्य स्थल-रिक्तियों का विवरण");
...
//        });
    ...
    private class SyncWorkSite extends AsyncTask<String, Void, ArrayList<SubDepartmentWiseVacancy>>
    {
        private final ProgressDialog dialog = new ProgressDialog(SubDeptWorkPlaceLegacyTableActivity.this);
        int optionType;
        String serial_no;
        ...
        protected ArrayList<SubDepartmentWiseVacancy> doInBackground(String...arg)
        {
            ...
            return WebserviceHelper.getSubDeptWiseVacencyReport("ShowWrk", dept_Code);
        }
        ...
        protected void onPostExecute(ArrayList<SubDepartmentWiseVacancy> result)
        {
            ...
            LegacyTableView.insertLegacyTitle("क्रम सं.","कार्य स्थल", "स्थान","संपर्क व्यक्ति","संपर्क व्यक्ति मोबाइल नं");
            //  LegacyTableView.insertLegacyTitle("क्रम सं.","पंजीकरण संख्या", "कौशल", "नाम", "लिंग","मोबाइल नंबर","कार्य स्थल का नाम");
            ...
            for (SubDepartmentWiseVacancy info: data)
            {

                LegacyTableView.insertLegacyContent(String.valueOf(i),info.getDept_WorkSiteName(),info.getDept_Location(),info.getDept_ContactPerson(),info.getDept_CPMobileNo());
                i++;
            }
