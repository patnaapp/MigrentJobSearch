...
public class WorkSiteLegacyTableViewActivity extends Activity implements AdapterView.OnItemSelectedListener  {
...
//        });
    ...
    {
        private final ProgressDialog dialog = new ProgressDialog(WorkSiteLegacyTableViewActivity.this);
        int optionType;
        String serial_no;
        ...
        protected ArrayList<DepartmentWiseVacancy> doInBackground(String...arg)
        {
            ...
            return WebserviceHelper.getDeptWiseVacencyReport("ShowWrk", dept_Code);
        }
