...
public class WebserviceHelper implements KvmSerializable {
    ...
    private Context ctx;
    public static final String SERVICENAMESPACE = "http://elabharthi.bih.nic.in/";
   // public static final String SERVICENAMESPACE = "http://164.100.251.15/";
    ...
    public static final String SERVICEURL = "http://164.100.251.15/elabhwebservice.asmx";
   ...
   // private static final String SEARCADAARBYID="getAadharbyid";
    ...
    } public static UserDetails getAdharUserDetail(String User_ID, String Pwd) {
        try {
            SoapObject res1;
            res1=getServerData(GETAADHAARUSERDETAIL, UserDetails.getUserClass(),"UserId","pwd",User_ID,Pwd);
            if (res1 != null) {
                return new UserDetails(res1);
            } else
                return null;
